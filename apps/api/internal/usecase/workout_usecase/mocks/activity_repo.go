...
func (_m *ActivityRepo) Create(ctx context.Context, a *model.Activity) error {
	ret := _m.Called(ctx, a)
...
// ActivityRepo_Create_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Create'
type ActivityRepo_Create_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - a *model.Activity
func (_e *ActivityRepo_Expecter) Create(ctx interface{}, a interface{}) *ActivityRepo_Create_Call {
	return &ActivityRepo_Create_Call{Call: _e.mock.On("Create", ctx, a)}
}

func (_c *ActivityRepo_Create_Call) Run(run func(ctx context.Context, a *model.Activity)) *ActivityRepo_Create_Call {
...
func (_c *ActivityRepo_Create_Call) Return(_a0 error) *ActivityRepo_Create_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ActivityRepo_Create_Call) RunAndReturn(run func(context.Context, *model.Activity) error) *ActivityRepo_Create_Call {
	_c.Call.Return(run)
	return _c
}
